...
# # Load configurations
# MONGO_CONNECTION_STRING = os.getenv("MONGO_CONNECTION_STRING", "mongodb+srv://Asif_Asees:root@das-cluster.tccl6d2.mongodb.net/retryWrites=true&w=majority&appName=DAS-cluster")
...
# Load configurations
MONGO_CONNECTION_STRING = os.getenv("MONGO_CONNECTION_STRING", "mongodb+srv://Asif_Asees:root@das-cluster.tccl6d2.mongodb.net/retryWrites=true&w=majority")
SPARK_MASTER = os.getenv("SPARK_MASTER", "spark://0.0.0.0:7077")
MAX_RETRIES = 3
...
# Set up logging configuration
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s', handlers=[logging.FileHandler('DAS.log'), mongo_handler])
